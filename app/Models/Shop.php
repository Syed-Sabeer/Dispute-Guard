...
class Shop extends Model
{
    ...
    public function emailTemplates() { return $this->hasMany(EmailTemplate::class); }
    ...
    public function settings() { return $this->hasOne(ShopSetting::class); }
    public function active(): bool { return $this->status === 'ACTIVE' && $this->uninstalled_at === null; }
    public function handle(): string { return substr($this->shop_domain, 0, -strlen('.myshopify.com')); }
}
