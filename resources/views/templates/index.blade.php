...
<td><s-link href="/templates/{{ $template->id }}/edit">Edit / preview</s-link> · <s-link href="/test-automation?dispute_reason={{ $template->dispute_reason }}&shipment_status={{ $template->shipping_state }}">Send test</s-link></td>
