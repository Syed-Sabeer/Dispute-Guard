...
@section('content')
@if(\App\Services\DeploymentMode::testTools())<div class="actions"><s-link href="/email-logs">All</s-link><s-link href="/email-logs?type=automatic">Automatic</s-link><s-link href="/email-logs?type=test">Tests</s-link></div>@endif
...
@empty<tr><td colspan="6">No customer emails have been sent yet.</td></tr>@endforelse
